...
public class ExtensionRegistryClientLogObserver implements LogObserver {
    private final BulletinRepository bulletinRepository;
    private final ExtensionRegistryClientNode clientNode;

    public ExtensionRegistryClientLogObserver(BulletinRepository bulletinRepository, ExtensionRegistryClientNode clientNode) {
