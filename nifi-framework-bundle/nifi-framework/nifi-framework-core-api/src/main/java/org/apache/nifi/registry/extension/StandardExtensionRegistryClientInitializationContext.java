...
public class StandardExtensionRegistryClientInitializationContext implements ExtensionRegistryClientInitializationContext {

    private final String identifier;
    private final ComponentLog logger;
    private final Optional<SSLContext> systemSslContext;

    public StandardExtensionRegistryClientInitializationContext(
