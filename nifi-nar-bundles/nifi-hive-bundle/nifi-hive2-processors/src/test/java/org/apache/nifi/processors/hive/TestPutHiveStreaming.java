...
public class TestPutHiveStreaming {
    ...
    public void onTrigger() throws Exception {
        ...
        assertEquals("1", runner.getFlowFilesForRelationship(PutHive2Streaming.REL_SUCCESS).get(0).getAttribute(HIVE_STREAMING_RECORD_COUNT_ATTR));
    }
    ...
    public void onTriggerWithPartitionColumns() throws Exception {
        ...
        runner.setProperty(PutHive2Streaming.TABLE_NAME, "users");
        runner.setProperty(PutHive2Streaming.TXNS_PER_BATCH, "100");
        runner.setProperty(PutHive2Streaming.PARTITION_COLUMNS, "favorite_number, favorite_color");
        runner.setProperty(PutHive2Streaming.AUTOCREATE_PARTITIONS, "true");
        Map<String, Object> user1 = new HashMap<String, Object>() {
            {
                put("name", "Joe");
    ...
    public void onTriggerWithWriteFailure() throws Exception {
        ...
        runner.assertTransferCount(PutHive2Streaming.REL_FAILURE, 1);
        assertEquals("2", runner.getFlowFilesForRelationship(PutHive2Streaming.REL_FAILURE).get(0).getAttribute(HIVE_STREAMING_RECORD_COUNT_ATTR));
    }
    ...
    private class MockPutHiveStreaming extends PutHive2Streaming {
