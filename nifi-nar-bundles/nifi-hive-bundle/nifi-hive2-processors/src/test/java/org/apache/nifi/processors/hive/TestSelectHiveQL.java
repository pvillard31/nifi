...
public class TestSelectHiveQL {
    ...
    public void setup() throws InitializationException {
        ...
        runner.setProperty(SelectHive2QL.HIVE_DBCP_SERVICE, "dbcp");
    }
    ...
    public void invokeOnTriggerWithCsv()
        ...
        invokeOnTrigger(QUERY_WITHOUT_EL, false, SelectHive2QL.CSV);
    }

    @Test
    public void invokeOnTriggerWithAvro()
            throws InitializationException, ClassNotFoundException, SQLException, IOException {
        invokeOnTrigger(QUERY_WITHOUT_EL, false, SelectHive2QL.AVRO);
    }
    ...
    public void invokeOnTrigger(final String query, final boolean incomingFlowFile, String outputFormat)
        ...
        if (SelectHive2QL.AVRO.equals(outputFormat)) {
            assertEquals(SelectHive2QL.AVRO_MIME_TYPE, flowFile.getAttribute(CoreAttributes.MIME_TYPE.key()));
            ...
            assertEquals(SelectHive2QL.CSV_MIME_TYPE, flowFile.getAttribute(CoreAttributes.MIME_TYPE.key()));
