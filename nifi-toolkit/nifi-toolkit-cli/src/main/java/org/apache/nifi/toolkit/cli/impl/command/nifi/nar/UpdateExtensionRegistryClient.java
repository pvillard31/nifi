...
/**
 * Command to update an extension registry client in NiFi.
 */
public class UpdateExtensionRegistryClient extends AbstractNiFiCommand<VoidResult> {

    public UpdateExtensionRegistryClient() {
        super("update-extension-reg-client", VoidResult.class);
    }

    @Override
    public String getDescription() {
        return "Updates the given extension registry client with a new name or description.";
    }
    ...
    public VoidResult doExecute(final NiFiClient client, final Properties properties)
        ...
        final ExtensionRegistryClientEntity existingRegClient = controllerClient.getExtensionRegistryClient(id);
        if (existingRegClient == null) {
            throw new CommandException("Extension registry client does not exist for id " + id);
        }
        ...
        controllerClient.updateExtensionRegistryClient(existingRegClient);
