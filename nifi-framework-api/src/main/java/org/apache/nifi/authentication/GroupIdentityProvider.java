...
public interface GroupIdentityProvider {
    ...
    /**
     * Return the groups associated to the provided user according to the underlying provider
     * @param credentials the credentials
     * @return the list of groups the user belongs to
     */
    List<String> getGroups(LoginCredentials credentials);
     ...
     */
    void initialize(GroupIdentityProviderInitializationContext initializationContext) throws ProviderCreationException;
     ...
     */
    void onConfigured(GroupIdentityProviderConfigurationContext configurationContext) throws ProviderCreationException;
